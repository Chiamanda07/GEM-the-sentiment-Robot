...
The body of Gem is open at the back for now in order to put the breadboard and parts of it in there.
...
# Future Works
Probably make a PCB to make the whole system compact
